...
<head>
    ...
    <style>
        ...
        .flow-connector.decision {
             padding-top: 0; /* Reduced to bring arrow closer to box above */
             padding-bottom: 6rem;
        }
        ...
        .arrow-down {
            width: 0;
            height: 0;
            border-left: 12px solid transparent; /* Enlarged from 10px */
            border-right: 12px solid transparent; /* Enlarged from 10px */
            border-top: 18px solid #d1d5db; /* Enlarged from 15px */
            margin: 0 auto;
        }
        .decision .arrow-down {
        ...
        .decision-branch {
            ...
            max-width: 500px;
            margin: 0 auto;
            padding-top: 1rem; /* Reduced to bring diamond closer to arrow */
            padding-bottom: 2rem;
        }
        .line-connector {
            height: 3px;
                    ...
                    <div class="p-6 md:w-2/3">
                        <div class="flex items-center gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-500">A sales tool where a link is sent to the customer. The completed details allow Presales to produce a maturity document for presentation.</p>
                            </div>
                        </div>
                         <div class="space-y-4">
                            <div class="path-description" data-type="easy"><strong class="text-green-600">Easy Customer:</strong> Completes the Health Check promptly, providing clear data for a straightforward maturity assessment.</div>
                            <div class="path-description" data-type="difficult"><strong class="text-red-600">Difficult Customer:</strong> Requires significant follow-up. Data may be incomplete, requiring more assumptions by Presales.</div>
                            <div class="path-description" data-type="current"><strong class="text-blue-600">Current Customer:</strong> Positioned as a value-add to benchmark current usage and identify new digital transformation opportunities.</div>
                        </div>
                    </div>
                    <div class="md:w-1/3 flex">
                         <div class="w-1/3 easy-customer-bg flex items-center justify-center" data-type="easy"><div class="path-title">Easy</div></div>
                    ...
                    <div class="p-6 md:w-2/3">
                        <div class="flex items-center gap-4 mb-4">
                         ...
                         <div class="space-y-4">
                            ...
                            <div class="path-description" data-type="difficult"><strong class="text-red-600">Difficult Customer:</strong> Presentation of Health Check document by Sales/Presales. Use findings to build credibility and open up discussion.</div>
                            <div class="path-description" data-type="current"><strong class="text-blue-600">Current Customer:</strong> Health Check findings are integrated into the QBR to provide data-driven insights and propose next steps.</div>
                        </div>
                    </div>
                     <div class="md:w-1/3 flex">
                         <div class="w-1/3 easy-customer-bg flex items-center justify-center" data-type="easy"><div class="path-title">Easy</div></div>
                ...
                <div class="flex flex-col md:flex-row">
                    <div class="p-6 md:w-2/3">
                        <div class="flex items-center gap-4 mb-4">
                            ...
                            <div><h2 class="text-2xl font-bold">6. Process Maps</h2><p class="text-gray-500">Presales-led workshops to document processes using Nintex, providing cost/time visibility for a business case.</p></div>
                        </div>
                         <div class="space-y-4">
                             <div class="path-description" data-type="easy"><strong class="text-green-600">Easy Customer:</strong> Clear process owners participate actively, resulting in quick, accurate maps.</div>
                             <div class="path-description" data-type="difficult"><strong class="text-red-600">Difficult Customer:</strong> Processes are undocumented. Workshops require more effort to extract information and gain consensus.</div>
                             <div class="path-description" data-type="current"><strong class="text-blue-600">Current Customer:</strong> Focus is on optimizing known processes or mapping new departments to expand the solution footprint.</div>
                        </div>
                    </div>
                    <div class="md:w-1/3 flex">
                        <div class="w-1/3 easy-customer-bg flex items-center justify-center" data-type="easy"><div class="path-title">Easy</div></div>
